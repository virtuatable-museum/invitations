RSpec.shared_examples 'invitation exists blocked' do
  describe 'when the invitation already exists blocked' do
    let!(:existing_invitation) { create(:invitation, status: :blocked, campaign: campaign, account: account) }
