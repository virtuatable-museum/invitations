RSpec.shared_examples 'invitation exists with an expelled status' do
  describe 'when the invitation already exists with an expelled status' do
    let!(:existing_invitation) { create(:invitation, status: :expelled, campaign: campaign, account: account) }
